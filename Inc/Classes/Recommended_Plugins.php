	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'options-general.php',       // Ex. wp-awesome-city-weather-report-settings /  edit.php?post_type=page .
				__( 'Recommended', 'wp-awesome-city-weather-report' ),
				__( 'Recommended', 'wp-awesome-city-weather-report' ),
				'manage_options',
				'wp-awesome-city-weather-report-recommended-plugins',
